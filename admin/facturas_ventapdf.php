<?php
    ...
    require('controllers/facturas/factura_venta.controller.php');
    use Dompdf\Dompdf;

    $dompdf = new Dompdf();
    $factura_ventas = new Facturaventa;
    $id_factura = $_GET['id_factura'];
    $producto = $factura_ventas -> readProductosFactura($id_factura);
    $cliente = $factura_ventas -> readClienteVenta($id_factura);
    $factura = $factura_ventas -> readFacturaVenta($id_factura);
    $html = '
                <head>
                    <title>Factura</title>
                    <style>
