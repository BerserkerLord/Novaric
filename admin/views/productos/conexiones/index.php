<div class="ps-5 pe-5 pt-3 pb-3 my-container active-cont">
    ...
    <nav>
        <ul class="pagination">
            <?php for($i = 0, $k = 1; $i < $conexiones -> total('codigo_producto', 'conexion'); $i+=10, $k++): ?>
                <li class="page-item"><a class="page-link" href="conexiones.php?<?php echo(isset($_GET['busqueda']))?'busqueda='.$_GET['busqueda'].'&':''; ?>&desde=<?php echo($i); ?>&limite=10"><?php echo ($k); ?></a></li>
            <?php endfor; ?>
        </ul>
    </nav>
    <?php
