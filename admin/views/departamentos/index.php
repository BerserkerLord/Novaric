<div class="ps-5 pe-5 pt-3 pb-5 my-container active-cont">
    ...
    <nav>
        <ul class="pagination">
            <?php for($i = 0, $k = 1; $i < $departamentos -> total(); $i+=3, $k++): ?>
                <li class="page-item"><a class="page-link" href="departamentos.php?<?php echo(isset($_GET['busqueda']))?'busqueda='.$_GET['busqueda'].'&':''; ?>&desde=<?php echo($i); ?>&limite=3"><?php echo ($k); ?></a></li>
            <?php endfor; ?>
        </ul>
    </nav>
    <?php
