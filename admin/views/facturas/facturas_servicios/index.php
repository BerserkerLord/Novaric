    ...
    <table class="table table-bordered">
        ...
        <?php foreach($datos as $key => $factura_servicio): ?>
            <tr>
                ...
                <td>
                    <a href="facturas_servicio.php?action=ver&id_factura=<?=$factura_servicio['id_factura']?>" class="btn btn-outline-secondary">
                        <i class="fa fa-eye p-1 icons"></i>
                    </a>
                    <a href="facturas_servicio.php?action=ver_estatus&id_factura=<?=$factura_servicio['id_factura']?>" class="btn btn-outline-primary">
